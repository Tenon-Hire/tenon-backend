...
def test_simulation_create_rejects_invalid_day_window_bounds() -> None:
    payload = _base_payload()
...
def test_simulation_create_day_window_overrides_feature_flag(monkeypatch) -> None:
    payload = _base_payload()
...
def test_simulation_create_day_window_overrides_validation(monkeypatch) -> None:
    monkeypatch.setattr(settings, "SCHEDULE_DAY_WINDOW_OVERRIDES_ENABLED", True)
