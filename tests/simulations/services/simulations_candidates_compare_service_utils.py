...
from app.simulations.services import (
    simulations_services_simulations_candidates_compare_service as compare_service,
)

derive_candidate_compare_status = compare_service.derive_candidate_compare_status
derive_fit_profile_status = compare_service.derive_fit_profile_status
list_candidates_compare_summary = compare_service.list_candidates_compare_summary
require_simulation_compare_access = compare_service.require_simulation_compare_access
