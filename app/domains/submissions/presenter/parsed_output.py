...
_OUTPUT_WHITELIST_KEYS = {"passed", "failed", "total", "stdout", "stderr", "summary", "runId", "run_id", "conclusion", "timeout"}
...
def process_parsed_output(parsed_output, *, include_output: bool, max_output_chars: int):
    ...
    if isinstance(parsed_output, dict):
        ...
        whitelisted_output = {key: parsed_output.get(key) for key in _OUTPUT_WHITELIST_KEYS if key in parsed_output}
